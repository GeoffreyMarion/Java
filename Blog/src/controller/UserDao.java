...
public class UserDao implements iDAO<User> {
	...
	public boolean create(User objet) {
		...
		return true;
			...
			System.out.println("Donn�es non cr�es");
			e.printStackTrace();
		}
		return false;
	}
	...
	public User update(String femail,String nom,String prenom,String pass,String email,String tel) {
		...
		else {System.out.println("Update non fait mail non pr�sent dans la base");}
		return null;
	}*/
	...
	public User findById(int id) {
		...
		if(afficher==null){System.err.println(id+" ne se trouve pas dans la base de donn�es\n----------------");
		}
		return null;
	}
	...
	public User findByEmail(String email) {
		...
		if(afficher==null){System.err.println(email+" ne se trouve pas dans la base de donn�es\n----------------");
		}
		return null;
	}
	...
	public ArrayList<User> findByNom(String nom) {
		...
		if(afficher==null){System.err.println(nom+" ne se trouve pas dans la base de donn�es\n----------------");
		}
		return null;
	}
