	...
	public JPanel write() {
		...
		publier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Article art = new Article(Ftitre.getText(),Fresume.getText(),artText.getText(),"fff",Mainframe.user.getPrenom());
				...
				else { JOptionPane.showMessageDialog(publier, "Article invalide");} 
			}
		});
